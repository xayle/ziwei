...
export const mockBaziPayload = {
  ...
  kongwang: ['戌', '亥'],
  pillar_details: {
    year: { hidden_stems: [{ stem: '丙', ten_god: '食神' }], xingyun: '帝旺', self_seat: '衰', nayin: '大林木', shensha: [{ name: '天乙', polarity: '+' }, { name: '亡神', polarity: '-' }] },
    month: { hidden_stems: [{ stem: '癸', ten_god: '正印' }], xingyun: '墓', self_seat: '养', nayin: '涧下水', shensha: [{ name: '华盖', polarity: '+' }] },
    day: { hidden_stems: [{ stem: '癸', ten_god: '正印' }], xingyun: '沐浴', self_seat: '长生', nayin: '海中金', shensha: [{ name: '将星', polarity: '+' }] },
    hour: { hidden_stems: [{ stem: '乙', ten_god: '劫财' }], xingyun: '衰', self_seat: '冠带', nayin: '大林木', shensha: [{ name: '驿马', polarity: '-' }] },
  },
  liunian: {
  ...
  dayun: {
    items: [{
      ...
      xingyun: '冠带',
      shensha: [{ name: '天德' }],
      hidden_stems: [{ stem: '己', ten_god: '正财' }],
    }],
  },
  shishen_summary: {
    dominant: ['正官', '正印'],
