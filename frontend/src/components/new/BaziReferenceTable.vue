...
<template>
  <section class="bazi-card">
    <div class="bazi-card__head">
      <div>
    ...
    <div class="bazi-card__table-wrap">
      <table class="bazi-table bazi-ref-table">
        <colgroup>
          <col class="bazi-table__label-col" />
          <col v-for="col in props.columns" :key="col.key" />
        </colgroup>
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr v-if="showDetailRows">
            <th class="bazi-table__row-label">
              <span class="bazi-table__label-with-icon">神煞<span class="bazi-table__arrow">▾</span></span>
            </th>
            <td
              v-for="col in props.columns"
              :key="`${col.key}-shensha`"
            ...
            >
              <div v-if="col.shensha?.length" class="shensha-list">
                <span v-for="item in col.shensha" :key="`${col.key}-${item}`" class="shensha-chip">{{ item }}</span>
              </div>
              <span v-else class="bazi-table__missing">缺失</span>
            </td>
          </tr>
    ...
    <div v-if="hiddenContribRows.length" class="bazi-card__contrib" data-testid="bazi-hidden-contrib">
      ...
      <table class="contrib-table">
        <thead><tr><th>十神</th><th>加权分</th></tr></thead>
        <tbody>
          <tr v-for="[god, score] in hiddenContribRows" :key="god">
            <td>{{ god }}</td>
