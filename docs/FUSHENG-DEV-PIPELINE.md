...
| **当前阶段** | **Phase F GTM** · T086–T094 ☑ → **下一项 T095**（H5 短 token） |
...
**下一项：** **T095** H5 短 token 读卷一摘要 — POST-W14 块 K
...
Phase F  W17+ GTM      ← **进行中** · T086–T094 ☑ · 下一项 T095
```
...
**下一步：** **T095** · H5 短 token 免登录读卷一摘要（可选）
