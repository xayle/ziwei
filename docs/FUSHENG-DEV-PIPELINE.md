...
| **当前阶段** | **Phase F GTM** · T086–T097 ☑ → **下一项 T098**（竖版分享预览 FE） |
...
**下一项：** **T098** 竖版分享预览 + 导出（FE-GTM-07）— POST-W14 块 K
...
Phase F  W17+ GTM      ← **进行中** · T086–T097 ☑ · 下一项 T098
```
