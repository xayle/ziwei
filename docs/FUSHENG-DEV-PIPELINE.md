...
| **当前阶段** | **Phase F GTM** · T086–T092 ☑ → **下一项 T093**（支付 webhook） |
...
**下一项：** **T093** 支付 webhook → entitlement — POST-W14 块 K
...
Phase F  W17+ GTM      ← **进行中** · T086–T092 ☑ · 下一项 T093
```
...
**下一步：** **T093** · 支付 webhook → 写 User.entitlement（沙箱）
