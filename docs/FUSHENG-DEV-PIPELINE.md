...
| **当前阶段** | **Phase F GTM** · T086–T096 ☑ → **下一项 T097**（抖音竖版卡） |
...
**下一项：** **T097** `export/card?layout=douyin` 9:16 — POST-W14 块 K
...
Phase F  W17+ GTM      ← **进行中** · T086–T096 ☑ · 下一项 T097
```
