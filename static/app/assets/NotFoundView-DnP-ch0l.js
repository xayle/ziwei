import{a5 as L,a6 as f,l as N,d as $,c as B,a as n,y as c,B as S,b as u,R as z,o as V,_ as W}from"./index-DnCNkKWF.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const U=({name:e,iconNode:o,absoluteStrokeWidth:t,"absolute-stroke-width":s,strokeWidth:a,"stroke-width":C,size:i,color:v,...x},{slots:p})=>{const{size:l,color:_,strokeWidth:b=2,absoluteStrokeWidth:g=!1,class:y=""}=M(),A=N(()=>{const d=w(t)||w(s)||t===!0||s===!0||g===!0,h=a||C||b||r["stroke-width"];return d?Number(h)*24/Number(i??l??r.width):h});return f("svg",{...r,...x,width:i??l??r.width,height:i??l??r.height,stroke:v??_??r.stroke,"stroke-width":A.value,class:E("lucide",y,...e?[`lucide-${k(j(e))}-icon`,`lucide-${k(e)}`]:["lucide-icon"])},[...o.map(d=>f(...d)),...p.default?[p.default()]:[]])};/**
 * @license @lucide/vue v1.16.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
