import{ac as L,ad as f,l as N,d as $,c as B,a as n,y as c,B as S,b as u,R as z,o as V,_ as W}from"./index-CskkgYAa.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const U=({name:e,iconNode:o,absoluteStrokeWidth:t,"absolute-stroke-width":s,strokeWidth:a,"stroke-width":C,size:i,color:v,...x},{slots:p})=>{const{size:d,color:_,strokeWidth:b=2,absoluteStrokeWidth:g=!1,class:y=""}=M(),A=N(()=>{const l=w(t)||w(s)||t===!0||s===!0||g===!0,h=a||C||b||r["stroke-width"];return l?Number(h)*24/Number(i??d??r.width):h});return f("svg",{...r,...x,width:i??d??r.width,height:i??d??r.height,stroke:v??_??r.stroke,"stroke-width":A.value,class:E("lucide",y,...e?[`lucide-${k(j(e))}-icon`,`lucide-${k(e)}`]:["lucide-icon"])},[...o.map(l=>f(...l)),...p.default?[p.default()]:[]])};/**
 * @license @lucide/vue v1.16.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
