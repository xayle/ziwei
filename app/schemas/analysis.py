...
class GejuModel(BaseModel):
    ...
    geju_detail: str | None = None  # 判断依据文字说明
...
class WealthAnalysisModel(BaseModel):
    ...
    fact_data: dict | None = None
    # 新增分析维度
    investment_preference: str | None = None  # 投资偏好方向
    financial_taboos: str | None = None  # 理财禁忌（忌神方向）
    wealth_accumulation_phases: str | None = None  # 财富积累三阶段
...
class CareerAnalysisModel(BaseModel):
    ...
    fact_data: dict | None = None
    # 新增分析维度
    entrepreneurship_assessment: str | None = None  # 创业vs打工评估
    five_year_roadmap: str | None = None  # 五年职业路线图
    collaboration_style: str | None = None  # 最佳合作方式
...
class MarriageAnalysisModel(BaseModel):
    ...
    fact_data: dict | None = None
    # 新增分析维度
    emotional_pitfalls: str | None = None  # 感情雷区与禁忌
    second_marriage_indicator: str | None = None  # 再婚/感情波折指标
...
class HealthAnalysisModel(BaseModel):
    ...
    fact_data: dict | None = None
    # 新增分析维度
    seasonal_health: str | None = None  # 季节性养生重点
    mental_health_advice: str | None = None  # 心理健康建议
    constitution_type: str | None = None  # 五行体质类型
...
class PersonalityModel(BaseModel):
    ...
    fact_data: dict | None = None
    # 新增分析维度
    communication_style: str | None = None  # 沟通风格
    stress_coping_mode: str | None = None  # 压力应对模式
    potential_activation: str | None = None  # 潜能激活时机建议
...
class MonthlyFortuneModel(BaseModel):
    ...
    month_ganzhi: str | None = None  # 月干支，如"甲子"
    dayun_stem: str | None = None  # 当前大运天干
    relation_to_rizhu: str | None = None  # 该月天干对日主的十神关系（N2.03）
    disclaimer: str = "仅供学术研究参考"
...
class LiuNianDetailModel(BaseModel):
    ...
    disclaimer: str = "仅供学术研究参考"
    # 前端展示扩展字段
    ten_god: str | None = None  # 流年天干与日主的十神关系
    flow_wuxing: str | None = None  # 流年天干五行(英文key)
    clash: str | None = None  # 流年地支冲克描述
