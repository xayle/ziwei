...
class BaguaResponse(BaseModel):
    ...
    bed_tip: Optional[FurnitureTipResponse] = Field(default=None, description="床头方位建议")
    desk_tip: Optional[FurnitureTipResponse] = Field(default=None, description="书桌/工位方位建议")
    door_tip: Optional[FurnitureTipResponse] = Field(default=None, description="大门方位建议")

    house_facing: Optional[str] = Field(default=None, description="房屋朝向代码")
    house_gua: Optional[int] = Field(default=None, description="房屋卦数")
    house_gua_name: Optional[str] = Field(default=None, description="房屋卦名")
    house_group: Optional[str] = Field(default=None, description="房屋组：东四宅 / 西四宅")
    compatibility: Optional[str] = Field(default=None, description="人宅相合：相合 / 不合")
    compatibility_note: Optional[str] = Field(default=None, description="相合说明")
...
class RoomLayoutRequest(BaseModel):
    ...
    house_facing: Optional[str] = Field(default=None, description="房屋朝向（可选）：N/NE/E/SE/S/SW/W/NW")
