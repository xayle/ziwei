...
class EventSignal(BaseModel):
    ...
    rule_id: str | None = None  # 对应 event_rules.json 规则 id
...
class YearEventRequest(BaseModel):
    ...
    event_types: list[str] = Field(
        default=["marriage", "wealth", "property", "career", "health"], description="要预测的事件类别，默认全部5类"
    )
