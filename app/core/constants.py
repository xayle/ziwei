...
DEFAULT_LON = 120.0
# Bazi verify/full: extended for CLS pre-1900 classical cases (sxtwl-backed pillars)
BAZI_VERIFY_YEAR_MIN = 1700
BAZI_VERIFY_YEAR_MAX = 2100
SUPPORTED_YEAR_RANGE = (BAZI_VERIFY_YEAR_MIN, BAZI_VERIFY_YEAR_MAX + 1)
