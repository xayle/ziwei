...
# 日主天干职场特质建议（10天干）
_STEM_CAREER_ADVICE: dict[str, str] = {
    "甲": "发挥开创型领导力，主动承担新项目或拓疆职责，以进取气势开辟属于自己的细分赛道",
    "乙": "以柔克刚，在大型组织中深耕一个专业领域成为隐形专家，善用人际弹性化解阻力",
    "丙": "凭借感召力与热情点燃团队，在公众面向或品牌输出岗位上最能释放光芒，避免低调埋没",
    "丁": "以沉稳细腻打磨专业深度，在精细化管理或高质量输出领域建立差异化竞争力，切忌急于求成",
    "戊": "以厚重包容气场构建稳固人脉基础，适合统筹协调型角色，资历积累后担任中流砥柱",
    "己": "以内敛务实的执行力赢得信任，专注将系统和流程做到极致，技能深耕带来不可替代的核心价值",
    "庚": "凭借执行精准度与标准化思维构建竞争壁垒，在规则清晰的机构或制度化环境中最能发挥所长",
    "辛": "以精致敏锐的审美与品质意识切入细分市场，在精品路线、品控或高端服务领域建立个人品牌",
    "壬": "善用灵活通透的思维捕捉跨界机遇，在变化快速的行业中以适应力与整合力制胜",
    "癸": "以深思熟虑的洞察力构筑研究型或顾问型竞争力，在数据分析、战略规划等深度工作中贡献最大价值",
}
...
def compute_career(
    ...
    # ─── 发展建议 ─────────────────────────────────────────────────────
    _stem_ca = _STEM_CAREER_ADVICE.get(day_stem, "")
    _stem_ca_sentence = f"【天干特质建议】{_stem_ca}。" if _stem_ca else ""
    if leadership:
        development_advice = (
